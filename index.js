...
const itemDescriptions = {
    ...
    'en': {
        '春节': 'First day of lunar January',
        '寒食节': '1-2 days before Qingming Festival',
        '清明节': 'April 4 (solar calendar)',
        '端午节': 'Fifth day of lunar May',
        '七夕节': 'Seventh day of lunar July',
        '除夕': 'Last day of lunar year',
        '除夕节': 'Last day of lunar year',
        '火锅': 'Introduction',
        '回锅肉': 'Introduction',
        '螺蛳粉': 'Introduction',
        '佛跳墙': 'Introduction',
